...
export class AdminApiAuthApiClient {
     ...
     * @return Success
     */
    login(body?: Login_Request | undefined): Observable<LoginResult> {
...
export class AdminApiRoleApiClient {
     ...
     * @return Success
     */
    createRole(body?: RoleDto | undefined): Observable<void> {
     ...
     * @return Success
     */
    updateRole(id: string, body?: RoleDto | undefined): Observable<void> {
...
export class AdminApiTestApiClient {
    ...
    testApi(): Observable<void> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processTestApi(response_ as any);
                } catch (e) {
                    return _observableThrow(e) as any as Observable<void>;
                }
            } else
    ...
    protected processTestApi(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (response as any).error instanceof Blob ? (response as any).error : undefined;
...
export class AdminApiTokenApiClient {
     ...
     * @return Success
     */
    refresh(body?: TokenRequest | undefined): Observable<LoginResult> {
...
export class Login_Request implements ILogin_Request {
    userName?: string | undefined;
    passWord?: string | undefined;

    constructor(data?: ILogin_Request) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (this as any)[property] = (data as any)[property];
    ...
    static fromJS(data: any): Login_Request {
        data = typeof data === 'object' ? data : {};
        let result = new Login_Request();
        result.init(data);
        return result;
    }
