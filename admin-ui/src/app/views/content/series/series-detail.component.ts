...
import { AdminApiSeriesApiClient, PostDto, SeriesDto } from './../../../../app/api/admin-api.service.generated';
...
public generateSlug(): void {
 ...
 onFileChange(event: Event): void {
  ...
  this.uploadService
    .uploadImage('posts', files)
    .subscribe({
      next: (response: any) => {
        this.form.get('thumbnail')?.setValue(response.path);
