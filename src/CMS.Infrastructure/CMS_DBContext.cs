...
{
    public class CMS_DBContext : IdentityDbContext<AppUser, AppRole, Guid>
    {
        public CMS_DBContext(DbContextOptions options) : base(options)
        {
        }
        ...
        public override Task<int> SaveChangesAsync(bool acceptAllChangesOnSuccess, CancellationToken cancellationToken = default)
        {
            ...
            foreach (var entityEntry in entries)
            {
                ...
                {
                    modifiedDateProp.SetValue(entityEntry, DateTime.Now);
                }
            }
